...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/admin-lte/2.3.0/css/skins/skin-red.css">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{route('admin')}}" class="logo">
            ...
            <span class="logo-lg"><b>Go</b>Rapid2</span>
        </a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="https://cdnjs.cloudflare.com/ajax/libs/admin-lte/2.3.0/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="https://cdnjs.cloudflare.com/ajax/libs/admin-lte/2.3.0/img/user2-160x160.jpg" class="user-image" alt="User Image">
